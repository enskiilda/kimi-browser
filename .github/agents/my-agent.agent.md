...
Describe what your agent does here...  ZMIEN INTEGRAACJE MODELU AI STAGEHAND NA PONIZSZY   import { Stagehand } from "@browserbasehq/stagehand";

const stagehand = new Stagehand({
  env: "BROWSERBASE",
  model: "moonshotai/kimi-k2-instruct-0905"
  // API key auto-loads from GROQ_API_KEY - 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
});

await stagehand.init();

HARDCODUJ NIE ZYCZE SOBIE ABSOLUTNIE ZZADNEGO ENV secretss variables 

GROQ_API_KEY=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

ONKERNEL_API_KEY=sk_d1b762ed-a8b5-416e-9692-64129a950be5.WAsoWIiEJP4Qs8RB5jb3FF2Fynz5x/JUUqKQ3nCgLdw

nie zachowuj w kodzie poprzedniej wersji kodu czy historii edycji, LEGACY - chce tylko i wylacznie miec czysty kod zedytowany przez ciebie bezwzględnie zawsze Pisz tylko i wyłącznie czysty kod ⚠️ UWAGA! KRYTYCZNY KOMUNIKAT DOTYCZĄCY HARDCODOWANYCH API! ⚠️
